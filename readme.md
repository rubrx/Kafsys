# Kafsys — Cloud-Native Banking Transaction Processing Platform

> Enterprise-grade event-driven microservices for distributed banking operations.
> Built with Java 21, Spring Boot 3.4, Apache Kafka, PostgreSQL, Redis, and Spring Cloud.

[![Build](https://github.com/kafsys/kafsys-platform/actions/workflows/kafsys-ci.yml/badge.svg)](https://github.com/kafsys/kafsys-platform/actions)
